...
public static class AppParameters
{
    ...
    private static void InitializeParameterRanges()
    {
        Parameters = new List<ParameterInfo>
        {
            ...
            new ParameterInfo(14,"Pole Rotation", 90, -180, 180, -200, 200, "Continuous", 0),
            new ParameterInfo(15,"Pole Long", 0, -100, 100, -200, 200, "Continuous", 0),
            new ParameterInfo(16,"Pole Lat", 0, -100, 100, -200, 200, "Continuous", 0),
            new ParameterInfo(17,"Tile Poles", 0, 0, 1, 0, 1, "Binary",0),
            new ParameterInfo(18,"Hyper Droste", 0, 0, 1, 0, 1, "Binary",0),
            new ParameterInfo(19,"Fractal Points", 1, 1, 10, 0, 20, "Step",1),
